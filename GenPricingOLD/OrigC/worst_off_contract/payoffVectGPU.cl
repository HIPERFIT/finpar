...
inline void trajectory_contract( // SIMPLE     
    ...
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat, 0, 1000., 4 );  
    ...
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat, 0, (-(1000. * (1. - x50))), 4 ); return;
L25:
	//model->notify_cash_flow(model, 0, 750., 4 /*2017-02-03, 2017-01-27, EUR*/); return;
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat,  0, 750., 4 ); return;
L24:
	//model->notify_cash_flow(model, 0, 1600., 3 /*2016-02-03, 2016-01-27, EUR*/); return;
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat,  0, 1600., 3 ); return;
L23:
	//model->notify_cash_flow(model, 0, 1450., 2 /*2015-02-03, 2015-01-27, EUR*/); return;
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat,  0, 1450., 2 ); return;
L22:
	//model->notify_cash_flow(model, 0, 1300., 1 /*2014-02-03, 2014-01-27, EUR*/); return;
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat,  0, 1300., 1 ); return;
L21:
	//model->notify_cash_flow(model, 0, 1150., 0 /*2013-02-01, 2013-01-27, EUR*/); return;
    trajectory_inner( model_num, ro_scal, model_discounts, local_vhat, 0, 1150., 0  ); return;
}
