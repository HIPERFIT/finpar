  ...
  for opt_set in opt_set_list:
    ...
    for (contract_j,contract) in enumerate(contract_list):
      for opt_j,opt in enumerate(opt_set):
        ...
        # return a bit left if the first two bars were zero
        if opt_j>=2:
          if db[opt_set[0]][contract][0]==0 and db[opt_set[1]][contract][0]==0:
            bar_left-=bar_width
        # bars
        bar_height=avg
        shape=ax.bar(
...
def image_draw(
  ...
  # extra text
  #P.text(extra_text_pos[0],     extra_text_pos[1]+0.055, "XX",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  #P.text(extra_text_pos[0]+0.04,extra_text_pos[1]+0.055, ": nVidia Quadro 2000M",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  #P.text(extra_text_pos[0]+0.01,extra_text_pos[1]+0.015, "XXX",color=axis_label_color,rotation='vertical',transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  #P.text(extra_text_pos[0]+0.04,extra_text_pos[1],       ": nVidia GeForce GTX 680",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  P.text(extra_text_pos[0]+0.005,extra_text_pos[1],       "XX",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  P.text(extra_text_pos[0]+0.05, extra_text_pos[1]+0.003, ": nVidia Quadro 2000M",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  P.text(extra_text_pos[0]+0.015,extra_text_pos[1]+0.090, "XXX",color=axis_label_color,rotation='vertical',transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  P.text(extra_text_pos[0]+0.05, extra_text_pos[1]+0.068, ": nVidia GeForce GTX 680",color=axis_label_color,transform = ax1.transAxes,fontsize=_TEXT_EXTRA_FONTSIZE)
  # save?
...
if __name__=="__main__":
  ...
  image_draw(
    ...
    scalings=_DATA_SCALINGS,
    filename_pre="optimizations-GPU-SR",
  ...
  image_draw(
    ...
    scalings=_DATA_SCALINGS,
    bars_text_offsets=[8,3],
    filename_pre="optimizations-GPU-MC",
