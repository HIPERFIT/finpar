...
//const REAL min_a = EPS0,     min_b = EPS0,     min_rho = -1.0+EPS0, min_nu = EPS0, min_sigma = EPS0;
//const REAL max_a = 1.0-EPS0, max_b = 1.0-EPS0, max_rho =  1.0-EPS0, max_nu = 0.2,  max_sigma = 0.2;
//const REAL max_a = 0.02,     ini_b = 0.02,     ini_rho =  0.0,      ini_nu = 0.01, ini_sigma = 0.04;
...
//if( g_rho[i] == 0.0 ) g_rho[i] = EPS0; // see if you can eliminate this!
}
