...
//              uint sobol_offset;
    ...
    private:
        ...
        cl_kernel mkMutateDimKernel ( ) {
            ...
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(real_t),          &MOVES_UNIF_AMPL_RATIO    );
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(uint),          &POP_SIZE                 );
            oclCheckError( ciErr1, CL_SUCCESS );
        ...
        cl_kernel mkMcMcDcKernel ( ) {
            ...
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(uint),          &sobol_offset             );
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(real_t),          &gamma_avg                );
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(real_t),          &ampl_ratio               );
            ciErr1 |= clSetKernelArg( kernel, counter++, sizeof(uint),          &POP_SIZE                 );
            oclCheckError( ciErr1, CL_SUCCESS );
